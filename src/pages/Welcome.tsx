...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Left side - Branding */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-accent/20 to-primary/5 items-center justify-end p-12 relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center lg:justify-start lg:pl-16 p-8">
